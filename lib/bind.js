...
!function (){
  ...
  var loopNode = function(selectorSpecifier, BoundDataMap, directive, element) {
  ...
  var parse = function(template, BoundDataMap, directive) {
    var processSelector = function(selectorSpecifier, directive, root) {
      ...
      map(elements, function(element) {
        ...
        if (type === 'object') {
          // Array
          loopNode(selectorSpecifier, BoundDataMap, directive, element);
        } else if (type === 'function') {
          // Function
