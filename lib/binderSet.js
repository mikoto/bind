...
//				var childBSet = parseDataToBinderSet(v);
				var childBSet = bSet.hasTemplateBinderSet() ? bSet.cloneChild() : createBinderSet();
	...
	bSet.setTemplateBinderSet = function(tbset) {
		!tbset.isBinderSet && error("Not BinderSet was appended!");
		return templateBinderSet = tbset;
	};
	
//	bSet.appendBinderToTemplateBinderSet = function(binder) {
//		!binder.isBinder && error("Not Binder was appended!");
...
//		return map(bSets, function(bSet) {
//			bSet.appendBinder(binder);
//		});
	};
...
//		!exist(templateBinderSet) && (bSet.setTemplateBinderSet( binderSet.clone() ));
	...
	bSet.clone = function() {
		...
		cloneBinderSet( bSet() );
//		map(bSets, function(bSet) {
//			cloneBinderSet.appendBinders(bSet.clone());
//		});
		return cloneBinderSet;
	};
